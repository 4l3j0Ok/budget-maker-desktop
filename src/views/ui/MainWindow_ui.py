...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        icon = QIcon()
        icon.addFile(u":/icons/views/assets/ic--baseline-menu.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        ...
        icon1 = QIcon()
        icon1.addFile(u":/icons/views/assets/eos-icons--project-outlined.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        ...
        icon2 = QIcon()
        icon2.addFile(u":/icons/views/assets/ic--baseline-lightbulb.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
